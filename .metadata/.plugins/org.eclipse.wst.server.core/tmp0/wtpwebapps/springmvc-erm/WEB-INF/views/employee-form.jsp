...
<label for="empfname" class="col-md-3 control-label"><b>First
Name</b></label>
<div class="col-md-9">
<form:input path="empfname" cssClass="form-control" />
<form:errors path="empfname" cssClass="error"/>
</div>
</div>
...
<form:errors path="emplname" cssClass="error"/>
</div>
</div>


<div class="form-group">
<label for="empdob" class="col-md-3 control-label"><b>Date
Of Birth</b></label>
<div class="col-md-9">
<form:input path="empdob" cssClass="form-control" />
<form:errors path="empdob" cssClass="error"/>
</div>
</div>
